...
export default {
  ...
  mounted() {
    this.naverLogin = new window.naver.LoginWithNaverId({
      clientId: "dNprlBhfXZmUB7quWgy8", //개발자센터에 등록한 ClientID
  ...
  methods: {
    logout() {
      ...
      const url = `/oauth2.0/token?grant_type=delete&client_id=dNprlBhfXZmUB7quWgy8&client_secret=UsiTeX0hV_&access_token=${accessToken}&service_provider=NAVER`;
